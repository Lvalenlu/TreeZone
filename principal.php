            ...
            <div class="modal-content">
                <div class="modal-body m-4" style="color: #529471;">
                    ...
                    <form>
                        ...
                        <div class="text-center">
                            <a href="/indexTreeZone.php" type="submit" class="btn mb-5 mt-4 py-2 px-5 fs-5 border-5 rounded-3" style="color: white; border-color: #529471; background-color: #529471;">Ingresar</a>
                        </div>
