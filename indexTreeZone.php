<?php
include_once 'scripts/locality/locality.php';
            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td><div class="btn-group d-flex">
                        <form action="view/locality/edit.php" method="post"><input type="hidden" name="id" value="<?php echo $locality['id'];?>"><input type="submit" class="btn btn-light me-5" value="Editar"></form>
                        <form action="view/locality/delete.php" method="post"><input type="hidden" name="id" value="<?php echo $locality['id'];?>"><input type="submit" class="btn btn-danger" value="Eliminar"></form>
                    </div></td>
                </tr>
                <?php } ?>
            </tbody>
