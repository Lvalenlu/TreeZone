<?php
include '../../scripts/locality/locality.php';
$id = $_POST['id'];
$localitys= locality::find($id);
?>
...
<div class="container mt-5" style="width: 30%;">
  <div class="row">
  <div class="card text-white pt-4 mt-5">
    <div class="card-body">
    <form action="../../scripts/locality/edit.php" method="POST">
  <div class="mb-3 mt-3">
    <input type="hidden" class="form-control" id="locality" name="id" value="<?php echo $localitys['id'] ?>">
    <input type="text" class="form-control" id="locality" placeholder="Enter locality" name="locality" value="<?php echo $localitys['locality'] ?>">
  </div>
  <div class="text-center">
  <button type="submit" class="btn my-2 mt-4 py-2 px-5 fs-5 border-5 rounded-3" style="color: white; border-color: #529471; background-color: #529471;">Crear</button>
  </div>
