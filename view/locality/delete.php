...
<div class="container mt-5" style="width: 35%;">
  <div class="row">
  <div class="card text-white my-5 pb-2">
    <div class="card-body fw-bolder text-center" >
      <h4 class="py-4" style="color: black;">¿Deseas eliminarlo permanentemente?</h4>
        
    <form action="../../scripts/locality/delete.php" method="POST">
    <input type="hidden" class="form-control" id="level" name="id" value="<?php echo $localitys['id'] ?>">
    <button type="submit" class="btn btn-danger mx-2">Eliminar</button>
    <a href="./" class="btn   mx-2" style="background-color: #529471;color: white;">Cancelar</a>
    </form>
    </div>
  </div>
