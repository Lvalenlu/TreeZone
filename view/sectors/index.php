<?php
include '../../scripts/sectors/sector.php';
    ...
    <main>
        ...
        <div class="modal fade" id="account" tabindex="-1" aria-labelledby="ModalFormLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body m-4" style="color: #529471;">
                    <button type="button" class="btn-close btn-close-black d-grid" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center justfy-content-center">
                        <div style="height: 100px;width: 100px; align-tracks: center; background-color: #35635b; color: white; border-radius: 50px; padding: 4px;font-size: ;">LB</div>
        ...
        <table class="table" style="background-color:#e5f1e3;">
            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td><div class="btn-group d-grid text-center">
                        <form action="./edit.php" method="post"><input type="hidden" name="id" value="<?php echo $sector['id'];?>"><input type="submit" class="btn btn-light my-3" value="Editar"></form>
                        <form action="./delete.php" method="post"><input type="hidden" name="id" value="<?php echo $sector['id'];?>"><input type="submit" class="btn btn-danger my-3" value="Eliminar"></form>
                    </div></td>
                </tr>
                <?php } ?>
            </tbody>
